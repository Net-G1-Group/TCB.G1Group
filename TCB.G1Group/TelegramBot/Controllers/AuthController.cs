...
public class AuthController:ControllerBase
{
    ...
    {
        await context.SendTextMessage(context,"Please Enter Login to Sign In");
    ...
    public async Task RegistrationStart(Context context)
    {
        ...
        await context.SendTextMessage(context,"Enter your phone number as \"+998900000000\"");
    ...
    {
        context.Session.AuthView.PhoneNumber = context.Update.Message.Text;
        await context.SendTextMessage(context,"Please Enter your password");
    ...
    public async Task RegistrationPassword(Context context)
    {
        ...
        await context.SendTextMessage(context,"You Succesfully registired");
